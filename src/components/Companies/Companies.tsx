  ...
  return (
    <>
      ...
      <Company
        ...
        description={
          "Was allocated to a financial client developing in-house web apps with Angular and C# to monitor IT infrastructure and integrating with Azure"
        }
        techStack={
      ...
      <Company
        ...
        description="This company was a startup for Real Estate in the Netherlands, I was the main developer responsible to build the web app in Angular and all the DevOps as well. Working closely with the designer to create a great UX experience. The main stack was a Angular 12 with Firebase, for state management we used NgRX, the main point for this project was to deeply work with and fully understand RxJS and Observable Pattern."
        techStack={
      ...
      <Company
        ...
        description="In ExxonMobil I was working with the global timekeeping team, I was lucky that when Exxon was initiating it's Agile Transformation I was starting at the company so I had so many opportunities to learn and practice it (Scrum/Kanban) what worked best for our team what didn't. Also in Exxon I had the opportunity to develop apps in a diverse range of stacks, since good old AngularJS to React.js, from ASP to .net Core 3.0, from SOAP to REST API fully deployed in Azure, one of the highlights in here was we had a third party app that it's API was in SOAP with XML and we had to build a UI for an timekeeping app using the vendor backbone, so we struggled a little bit to understand the documentation and created a completely new RESTFul API that did the SOAP communication and all the business logic and we sent the frontend app only the required data, with swagger and the API fully tested"
        techStack={
